package com.example.administrator.payprice;
...
//		paySignFromServer();
    ...
    private void paySignFromClient() {
        //获得订单信息
        String orderInfo = getOrderInfo("iPhone7 Puls(亮黑色)", "购买一部手机", "10000.00");
        //进行加密签名
    ...
    private void paySignFromServer() {
        ...
        http.send(HttpMethod.POST, URL_JSON + sb.toString(), new RequestCallBack<String>() {
            @Override
